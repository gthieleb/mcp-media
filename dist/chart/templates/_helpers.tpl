...
*/}}
{{- define "media-controller.fullname" -}}
...
*/}}
{{- define "media-controller.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "media-controller.resourceName" -}}
{{- $fullname := include "media-controller.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "media-controller.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "media-controller.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
